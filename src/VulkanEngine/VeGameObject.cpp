...
VeGameObject::VeGameObject(void) { *this = createGameObject(); }
...
VeGameObject VeGameObject::makePointLight(float intensity, float radius,
										  vem::vec3 color) {
...
const uint32_t VeGameObject::getId(void) { return (_id); }
