...
void SimpleRender::createPipeline(VkRenderPass renderPass) {
	...
	_vePipeline =
		make_unique<VePipeline>(_veDevice, "shader/simpleShader.vert.spv",
								"shader/simpleShader.frag.spv", pipelineConfig);
}

SimpleRender::SimpleRender(VeDevice &device, VkRenderPass renderPass,
